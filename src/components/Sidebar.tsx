...
export function Sidebar() {
  return (
    <header className="flex flex-col justify-between border-b border-border pb-10 pt-16 lg:sticky lg:top-0 lg:h-screen lg:w-[340px] lg:shrink-0 lg:border-b-0 lg:py-24">
      <div>
